// pages/ProductMain2.dart
// pages/ProductMain2 copy.dart
...
class ProductMain2Page extends StatefulWidget {
  const ProductMain2Page({super.key, required this.title});

  final String title;

  @override
  State<ProductMain2Page> createState() => _ProductMain2PageState();
}

class _ProductMain2PageState extends State<ProductMain2Page> {
  late List products;
  late List category;
  late List brand;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("${msg}", style: kTextTheme.displayMedium),
              _row2(),
              _row1("Categories ", "  See More"),
              categoryItems(),
              _row1("Brands", "  See More"),
              brandItems(),
            ...
            onTap: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      fullscreenDialog: true,
                      builder: (context) =>
                          productbyBrandPage(title: brand[index]["BrandID"])));
            },
            child: Container(
              padding: const EdgeInsets.all(5),
              decoration: BoxDecoration(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage(brand[index]["Image"]),
                          fit: BoxFit.contain),
                    ),
                  ),
                  const SizedBox(height: 5),
