...
class AddBrandPage extends StatefulWidget {
  const AddBrandPage({super.key, required this.title});
...
class _AddBrandPageState extends State<AddBrandPage> {
    ...
    if (_formKey.currentState!.validate()) {
      setState(() {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('Your Brand has been Added',
  ...
  Future<http.Response> _AddBrand() async {
    final http.Response response = await Network().postData({
      "name": name,
      "desc": desc,
      "image": "assets/images/shop/product/29.jpg",
    }, '/addBrand.php');
            ...
            child: Form(
              ...
              child: Center(
                child: Column(
                  ...
                  children: <Widget>[
                    Text('AddBrand', style: kTextTheme.displayMedium),
                    Text(
                      '${msg}',
                      style: TextStyle(
                          fontSize: 20,
