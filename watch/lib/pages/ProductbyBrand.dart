...
class productbyBrandPage extends StatefulWidget {
  const productbyBrandPage({super.key, required this.title});

  final String title;

  @override
  State<productbyBrandPage> createState() => _productbyBrandPageState();
}

class _productbyBrandPageState extends State<productbyBrandPage> {
  late List products;
  late List brand;
  ...
  Future<http.Response> _getProduct1() async {
    final http.Response response = await Network()
        .postData({"bid": widget.title}, '/getProductbyBrand.php');
