...
class EditBrandPage extends StatefulWidget {
  const EditBrandPage({super.key, required this.title});
...
class _EditBrandPageState extends State<EditBrandPage> {
  ...
  Future<http.Response> _getProduct1() async {
    final http.Response response =
        await Network().postData({"bid": widget.title}, '/getBrandbyID.php');
  ...
  Future<http.Response> _EditBrand() async {
    final http.Response response = await Network().postData(
        {"name": name, "desc": desc, "image": "assets/images/shop/product/41.jpg", "bid": widget.title},
        '/EditBrand.php');
            ...
            child: Form(
              ...
              child: Center(
                child: Column(
                  ...
                  children: <Widget>[
                    Text('Edit Product of Brand id ${widget.title}',
